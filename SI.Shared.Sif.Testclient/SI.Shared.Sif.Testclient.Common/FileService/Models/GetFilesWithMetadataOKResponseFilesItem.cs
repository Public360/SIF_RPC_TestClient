...
namespace SI.Shared.Sif.Testclient.Common.Models
{
    ...
    public partial class GetFilesWithMetadataOKResponseFilesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// GetFilesWithMetadataOKResponseFilesItem class.
        /// </summary>
        public GetFilesWithMetadataOKResponseFilesItem() { }

        /// <summary>
        /// Initializes a new instance of the
        /// GetFilesWithMetadataOKResponseFilesItem class.
        /// </summary>
        public GetFilesWithMetadataOKResponseFilesItem(int? documentRecno = default(int?), string documentNumber = default(string), string accessGroup = default(string), object customFields = default(object), int? recno = default(int?), string title = default(string), string format = default(string), string base64Data = default(string), string uRL = default(string), string relationTypeDescription = default(string), string relationTypeCode = default(string), string versionFormatDescription = default(string), string versionFormatCode = default(string), string type = default(string), string note = default(string), string modifiedBy = default(string), string checkedOutBy = default(string), string categoryDescription = default(string), string categoryCode = default(string), string statusDescription = default(string), string statusCode = default(string), string accessCodeDescription = default(string), string accessCodeCode = default(string), string paragraph = default(string), DateTime? degradeDate = default(DateTime?), string degradeCode = default(string), DateTime? disposalDate = default(DateTime?), string disposalCode = default(string), bool? filedOnPaper = default(bool?), string paperLocation = default(string), DateTime? signDate = default(DateTime?), string accessCodeRecno = default(string), int? version = default(int?), DateTime? lastChangedDate = default(DateTime?))
        {
